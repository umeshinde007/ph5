                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        ...
                        <div id="register" class="animate form">
                            <form  autocomplete="off" method="post" onsubmit=" return insertdata()"> 
                                <h1> Sign up </h1> 
                                <p> 
...
<script type="text/javascript">
    function insertdata()
    {
     ...
     var passcnf =("#passwordsignup_confirm").val();
     // var age=("#age").val();
     ...
     $.ajax({
               ...
               data: {user:user,email:email,pass:pass,passcnf:passcnf},
